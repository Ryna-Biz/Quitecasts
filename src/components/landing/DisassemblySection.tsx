...
export function DisassemblySection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-screen bg-gradient-to-b from-[#05080D] to-[#09111A] flex flex-col items-center justify-center overflow-hidden py-20"
    >
      ...
      <svg
        ref={svgRef}
        viewBox="0 0 800 600"
        className="w-full max-w-4xl h-auto px-6"
        style={{
