...
export function PodcastPage({ id, onNavigate }: { id: string; onNavigate: (path: string) => void }) {
    ...
    const [subscribed, setSubscribed] = useState(() => storage.getSubscriptions().includes(id))
